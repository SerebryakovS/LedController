...
//  ./ImageViewer --led-rows=64 --led-cols=64 --led-pwm-bits=1 --led-rgb-sequence="GRB" logo.png
...
int main(int argc, char *argv[]) {
  ...
  printf("Size: %dx%d. Hardware gpio mapping: %s\n",
    ...
    matrix_options.row_address_type = 0; // ABC-addressed panels
    matrix_options.pwm_bits = 1;			
	matrix_options.show_refresh_rate = true;
	matrix_options.pwm_lsb_nanoseconds = 1000;
